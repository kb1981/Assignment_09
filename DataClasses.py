...
class Track():
    ...
    def position(self, value):
        if type(value) == int:
            ...
            print('Position needs to be an Integer!')
    ...
    def __str__(self):
        ...
        return f"CD {self.position} is {self.title} and is {self.length} long"
...
class CD:
    ...
    def add_track(self, track: Track) -> None:
        ...
        Args:
            cd_track (Track): Track object to be added to CD / Album.
    ...
    def rmv_track(self, track_id: int) -> None:
        ...
        try:
            ...
            if track_id >= 0:
                del self.__cd_tracks[track_id]
                self.__sort_tracks()
            else: 
                print ('That track does not exist! Select [a] to add it! \n')
                return
        except IndexError:
            print ('Nothing to remove!')
        except ValueError:
            print ('Must enter a number here! \n')
    ...
    def get_tracks(self) -> str:
        ...
        if len(self.__cd_tracks) < 1:
            print ('No tracks have been input for this album!  Select [a] to add tracks.')
        result = ''
        for track in self.__cd_tracks:
            if track is None:
