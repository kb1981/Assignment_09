...
class FileIO:
                ...
                for disc in lst_Inventory:
                    ...
                    for track in tracks:
                        if track is not None:
                            record = '{},{}'.format(discID, track.get_record())
                            file.write(record)
    ...
    def load_inventory(file_name: list) -> list:
        ...
        try:
            ...
            print('The file', file_name_CD, 'was created for you to use! Select [a] to add inventory.\n')
        except EOFError:
        ...
        try:
            ...
            print('The file', file_name_Track, 'was created for you to use! Select [a] to add inventory.\n')
        except EOFError:
            print('Lets add some CDs!  Select [a] to get started! \n')
